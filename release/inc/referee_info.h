...
typedef enum
{
	...
	DART_INFO_CMD_ID     	          = 0x0105,//���ڷ���ڵ���ʱ
	
    ROBOT_STATE_CMD_ID                = 0x0201,//������״̬����
    POWER_HEAT_DATA_CMD_ID            = 0x0202,//ʵʱ������������
    ROBOT_POS_CMD_ID                  = 0x0203,//������λ������
    BUFF_CMD_ID                  	  = 0x0204,//��������������
    AIR_SUPPORT_DATA_CMD_ID        	  = 0x0205,//���л���������״̬����
    HURT_DATA_CMD_ID                  = 0x0206,//�˺�״̬����
    SHOOT_DATA_CMD_ID                 = 0x0207,//ʵʱ�������
	PROJECTILE_ALLOWANCE_CMD_ID       = 0x0208,//�ӵ�ʣ�෢����
	RFID_STATUS_CMD_ID				  = 0x0209,//������ RFID ״̬
	DART_CLIENT_CMD_CMD_ID         	  = 0x020A,//���ڿͻ����˻���ָ����
	GROUND_ROBOT_POSITION_CMD_ID	  = 0x020B,
	RADAR_MARK_DATA_CMD_ID			  = 0x020C,
	SENTRY_INFO_CMD_ID				  = 0x020D,
	RADAR_INFO_CMD_ID				  = 0x020E,
	
    ROBOT_INTERACTION_DATA_CMD_ID     = 0x0301,//�����˼佻������
	CUSTOM_ROBOT_DATA_CMD_ID		  =	0x0302,//�Զ���������������ݽӿ�
	MAP_COMMAND_CMD_ID				  =	0x0303,//�ͻ���С��ͼ��������
	REMOTE_CONTROL_CMD_ID			  = 0x0304,//���̡������Ϣ
	MAP_ROBOT_DATA_CMD_ID			  = 0x0305,//�ͻ���С��ͼ������Ϣ
