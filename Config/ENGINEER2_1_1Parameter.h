...
#define ARM_MOTOR2_SPEED_INIT_PID_KP 6
...
//---------------------------------------银矿初始化参数-----------------------------------------
// 机械臂关节0双环pid参数
#define SILVER_MOTOR0_ANGLE_INIT_PID_KP 15
#define SILVER_MOTOR0_ANGLE_INIT_PID_KI 0
#define SILVER_MOTOR0_ANGLE_INIT_PID_KD 0
#define SILVER_MOTOR0_SPEED_INIT_PID_KP 6
...
//---------------------------------------银矿普通参数-----------------------------------------
// 机械臂关节0双环pid参数
#define SILVER_MOTOR0_ANGLE_PID_KP 15
#define SILVER_MOTOR0_ANGLE_PID_KI 0
#define SILVER_MOTOR0_ANGLE_PID_KD 0
#define SILVER_MOTOR0_SPEED_PID_KP 6
