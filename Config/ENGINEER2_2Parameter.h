...
//视觉抬升角度环参数
#define VIEW_LIFT_MOTOR_ANGLE_PID_KP 20
#define VIEW_LIFT_MOTOR_ANGLE_PID_KI 0		
...
//抬升左速度环参数
#define LIFT_MOTOR_LEFT_SPEED_KP 3
#define LIFT_MOTOR_LEFT_SPEED_KI 0
#define LIFT_MOTOR_LEFT_SPEED_KD 0

//抬升右速度环参数
#define LIFT_MOTOR_RIGHT_SPEED_KP 3
...
//抬升右角度环参数
#define LIFT_MOTOR_RIGHT_ANGLE_KP 50
